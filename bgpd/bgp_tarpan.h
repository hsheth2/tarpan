...
struct tarpan_protocol_handler
{
  ...
  /* optional functions */
  int (*protocol_info_cmp) (struct bgp *bgp, struct bgp_info *nw,
...
extern void tarpan_update_packet (struct peer *const peer, struct tarpan * tarp);
...
extern unsigned int tarpan_hash_make (const struct tarpan *);
